<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="updateGPAdvisor.aspx.cs" Inherits="advisor.updateGP" %>
...
<body>
    <form id="form1" runat="server">
        <div>
            <asp:Label runat="server" Text="Expected Graduation Date"></asp:Label>
        </div>
        ...
        <div class="wlp-whitespace-only-element-expansion">
            <asp:Button runat="server" Text="Update" OnClick="updatebt"></asp:Button>&nbsp;</div>
            <div class="wlp-whitespace-only-element-expansion">
